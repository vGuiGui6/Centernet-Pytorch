...
if __name__ == "__main__":
    ...
    #   常差的情况下冻结训练需要的显存较小，显卡非，可设置Freeze_Epoch等于UnFreeze_Epoch，此时仅仅进行冻结训练。
    #      
    ...
    #------------------------------------------------------------------#
    num_workers         = 1   # 原本为8，0表示关闭，1表示只有一个worker进程用来加载batch数据，而主进程不参数数据加载，num_workers依赖于batch size和机器性能
